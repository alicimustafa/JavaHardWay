// version with out function is longer 
public class HeronsFormula {
  ...
  //this function computes the area of a treangle with side lenght a, b, & c.
  public static double triangleArea(int a, int b, int c){
    ...
    //After computing the area, you must "return" the computer value:
    return A;
  }
}
